...
# arctic block #1
# moo@b1:~/.arctic$ arcticcoin-cli getblockhash 1
# 000007d91d1254d60e2dd1ae580383070a4ddffa4c64c2eeb4a2f9ecc0414343
# moo@b1:~/.arctic$ arcticoin-cli getblock 000007d91d1254d60e2dd1ae580383070a4ddffa4c64c2eeb4a2f9ecc0414343
# {
...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_arctic_hash(self):
        self.pow_hash = hexlify(arctic_hash.getPoWHash(self.block_header))
